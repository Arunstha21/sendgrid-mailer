...
export default function CheckMatchData({matchData, setMatchData, matchNo}: {matchData: MatchData | null; setMatchData: (matchData: MatchData) => void; matchNo: string | undefined;}) {
  ...
  return (
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Button className="mt-4" onClick={updatePlayerDataHandler} >Update Player Data</Button>
      </DialogContent>
    </Dialog>
    </>
    </div>
